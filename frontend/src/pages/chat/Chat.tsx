                  ...
                  <Stack>
                    <div className={styles.textContainer}>
                      <p className={styles.chatEmptyTitle}>
                        <span className={styles.chatEmptyBrand}>
                          Azure OpenAI
                        </span>{" "}
                        - Your Virtual HIRA Assistance
                      </p>
                      <p className={styles.chatLine}>
                        HIRA assistance is build on top of Azure Open AI's Large
                        Language Model. This result in better assistance for
                        operational safety and compliance for ETEX.
                      </p>
                    </div>
                  </Stack>
                ) : (
